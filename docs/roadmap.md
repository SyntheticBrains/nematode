...
- ⬜ **B.1** data vendored with provenance and licence; the wiring × weight-prior 2×3 under the reading learner and PPO, head scope and full scope reported separately. *(Progress 2026-09-24: data vendored at B.1a; the pilot (B.1b, [Logbook 072](experiments/logbooks/072-measured-prior-pilot.md)) swept the multiplier on both learners and selected **1.0**, the magnitude-matched point, by a rule that never read the wiring gap; the 2×3 is B.1c.)*

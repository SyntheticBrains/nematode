...
- ⬜ **A.2** sensitivity surface over the five pins on the reading learner **and the three shared pins on PPO**; every later contrast at a point swept for the learner it uses (D16 as amended).

...
| M6 | Transgenerational memory (gated on M3 ✅ + M4/M5 ✅) | HIGH | 🟡 ready to start — **highest-novelty remaining Phase 5 milestone**, all gates cleared (M3 GO ✅, M4 closed STOP ✅, M5 closed STOP ✅). **May 2026 literature update**: Posner 2023 is actively contested but not retracted; [Vidal-Gadea independent validation (eLife Nov 2025)](https://elifesciences.org/articles/107034) confirmed F1+F2 retention with documented protocol-sensitivity; [Hunter lab critique (eLife reviewed preprint)](https://elifesciences.org/articles/100254) + [Murphy rebuttal (bioRxiv 2025)](https://www.biorxiv.org/content/10.1101/2024.06.07.597568v2) frame the controversy. **Decision gate corrected** per [Kaletsky et al. (Murphy lab, eLife May 2025)](https://elifesciences.org/articles/105673) and the Vidal-Gadea independent validation (which both show F1/F2 retention well above the original 10% floor; Kaletsky reports F2 choice index in the 0.5-0.6 range on PA14): GO if F1 ≥40%, F2 ≥25%, F3 ≥15% with monotone non-increasing decay; original F3 ≤10% gate would have marked successful biological replication as STOP. [Cross-species variability (bioRxiv Apr 2026)](https://www.biorxiv.org/content/10.64898/2026.04.10.717426v1) motivates adding a paired TEI-on/off lineage comparison. **No computational TEI replication exists** as of May 2026 — M6 occupies a genuinely open niche. Substrate ingredients already shipped: M3's `WeightPersistence` + `LamarckianInheritance` (heritable substrate proven bit-exact) + Phase 1's predator/pathogen-avoidance reward machinery |

...
| M6 | Transgenerational memory (gated on M3 + M4/M5) | HIGH | 🔲 not started — **highest-novelty remaining Phase 5 milestone**. 2025 mechanism literature converges on the project's deliverable-5 design: [SET-24 + HCF-1 maintaining TEI (Nat Commun 2025)](https://www.nature.com/articles/s41467-025-68200-7), [pathogen-avoidance molecular requirements (bioRxiv Jan 2025)](https://www.biorxiv.org/content/10.1101/2025.01.21.634111v1), [nucleus-independent small-RNA inheritance (Sci Adv)](https://www.science.org/doi/10.1126/sciadv.adj8618), [eLife 2025 review on learned avoidance](https://elifesciences.org/articles/109427). Substrate ingredients already shipped: M3's `WeightPersistence` + `LamarckianInheritance` (heritable substrate proven bit-exact) + Phase 1's predator/pathogen-avoidance reward machinery. **Design-in-parallel-with-M5-pilot** rather than serial-after to overlap |
| M6.5 | NEAT topology evolution (optional) | LOW | 🔲 not started — cost dropped via [TensorNEAT (GPU-accelerated NEAT, 2024-2025)](https://arxiv.org/pdf/2504.08339); 2025 NEAT-vs-PPO comparison reported NEAT +25% on inventory tasks at 1k gens. Note for budget planning if scheduled |

...
- 🔲 L3 NEAT topology-search results comparing the wild-type connectome to NEAT-evolved topologies on at least one behaviour, with the lag-matrix or equivalent discriminative instrument, **and against degree-preserving rewired-null topologies under matched initialisation + training budget** (the control that makes the connectome-vs-topology verdict credible — Dhiman 2026).

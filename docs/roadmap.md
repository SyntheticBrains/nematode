...
| M5 | Co-evolution arms race | HIGH | 🔲 not started — **headline scientific milestone post-M4**. Recent literature ([Sakana Digital Red Queen 2025](https://pub.sakana.ai/drq/), [Sci Reports 2026 dual-trait predator-prey](https://www.nature.com/articles/s41598-026-50762-1), [Entropy MARL co-evolution 2021](https://www.mdpi.com/1099-4300/23/4/461)) supports Red Queen dynamics + multi-dim trait-space stability. M5 ships with **secondary Baldwin instrumentation** (per-gen prey hyperparam spread + periodic F1 elite-vs-prior at K'-train) to opportunistically answer the Baldwin question without a dedicated M4.7 pilot. Decision gate softened to disjunctive: GO if **(a) phenotypic cycling visible OR (b) measurable trait escalation in at least one trait dim** over ≥30 gens — recent eco-evo literature shows stable populations + cycling traits can coexist, so conjunctive "cycling AND monotonic escalation" is too strong |

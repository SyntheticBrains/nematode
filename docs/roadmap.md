...
| **8b stalls before the combined paper** *(added 2026-09-26)* | C.1d's MLP positive control fails, or C.1e has not read out by 2026-12-31 | The 8a package ships on its own (A.5's fallback), with Logbook 076's inventory as its content; the literature watch can also reopen A.5 at any time. |

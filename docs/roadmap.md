...
| M2 | Hyperparameter evolution pilot | LOW | ✅ complete (3 arms GO; predator arm +47pp on 4 seeds is the non-saturated landscape M3 needs as a prerequisite — see logbook 012) |

...
> **Anti-scope-creep**: promoting a SHOULD or MAY family to MUST (so that family's results gate a Phase 6 exit criterion) requires amending [openspec/changes/phase6-tracking/design.md § Decision 4](../openspec/changes/archive/2026-07-06-phase6-tracking/design.md) before the promoting tranche merges. Same for adding a tenth family beyond the nine listed here. The amendment must document the cross-tranche budget impact.

...
| 010 | [Aerotaxis Baselines](logbooks/010-aerotaxis-baselines.md) | halted | Oxygen sensing (aerotaxis) oracle baselines across 7 scenarios + 2 thermal controls. Adding O2 drops thermal-only performance by 10-24pp. Agent learns dual O2+thermal navigation. Temporal GRU plateaus at 13% L1000 (oracle 72%) on medium — deferred to large grid derivative/temporal evaluation. |

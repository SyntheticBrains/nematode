...
| 010 | [Aerotaxis Baselines](logbooks/010-aerotaxis-baselines.md) | in_progress | Oracle + derivative + temporal evaluation. Derivative exceeds oracle on all 6 scenarios (+4pp to +28pp). Large grid temporal achieves 99% L100 (vs oracle 79%) — medium grid plateau was a grid-size problem. Remaining: temporal evaluation on combined/predator scenarios. |

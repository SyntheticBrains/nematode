...
| 011 | [Multi-Agent Phase 4 Evaluation](logbooks/011-multi-agent-evaluation.md) | in-progress | 7 campaigns evaluating multi-agent coordination, social dynamics, pheromones. Key findings: temporal collective exploration advantage (+14.3%), social feeding +35% food under scarcity, zero coordination overhead with proportional resources, pheromones neutral across all scenarios. Two critical bugs (#112, #115) found and fixed. |

...
trials × 6 arm/parameter combinations. `control.json` is the full output and `per-seed.csv` the
...
|---|---|---|---|---|
| `analytic` (reference) | −0.1361 | 8/8 | +1.0 while learning | passes |
...
- 48 runs (8 seeds × 6 arm/parameter combinations), single process, no environment.

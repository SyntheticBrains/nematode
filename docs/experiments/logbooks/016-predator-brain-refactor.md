...
- **Forensic notes** (saturation finding, raw per-cell numbers, intermediate decisions): [`tmp/evaluations/evolution/evolution_scratchpad.md`](../../../tmp/evaluations/evolution/evolution_scratchpad.md) § 2026-05-05 — M1 (gitignored; persists locally)

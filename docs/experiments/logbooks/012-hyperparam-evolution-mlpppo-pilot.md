...
- [x] This-PR M2 invariants: tick `M2.4`, `M2.6`, `M2.7`, `M2.8`, `M2.9`, `M2.10`, `M2.11`, `M2.12` in [`openspec/changes/phase5-tracking/tasks.md`](../../../openspec/changes/phase5-tracking/tasks.md); flip M2 status header to `complete`; flip [`docs/roadmap.md`](../../../docs/roadmap.md) M2 row to `✅ complete`.

...
- Export the connectome for Wormlight: `uv run python scripts/export_wormlight.py --out <path>` (refuses uncommitted changes to tracked files unless `--allow-dirty`)

...
- `packages/quantum-nematode/quantumnematode/` — Main source code
  - `brain/arch/` — 15 brain architectures: qvarcircuit, qqlearning, qrc, qrh, crh, qsnnreinforce, qsnnppo, qliflstm, hybridquantum, hybridclassical, hybridquantumcortex, mlpreinforce, mlpdqn, mlpppo, spikingreinforce

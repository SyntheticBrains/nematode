...
- Recalibration happens via a commit to this design.md *before* the gate fires (i.e. before the triggering tranche closes), naming the criterion being recalibrated, the in-flight evidence motivating the change, and (where applicable) the alternative criterion that's replacing it.

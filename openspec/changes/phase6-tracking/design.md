...
- (G3.c) Env-upgrade delta analysis shipped — head-to-head ranking comparison between T4-grid and T7-upgraded for the 4 integrated-C3 cells (+ extracted per-behaviour sub-metrics) that exist in both (RQ5). The delta is the load-bearing reason for the deliberate T4/T7 split.

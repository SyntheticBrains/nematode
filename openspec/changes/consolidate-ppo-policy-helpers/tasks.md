...
- [x] 2.7 `test_reservoir_hybrid_base.py`, `test_qef.py`, `test_crh.py`, `test_qrh.py`, `test_crhqlstm.py`, `test_qrhqlstm.py` — **248 passed, unchanged**. Full suite **4078 passed, 1 skipped, 2 xfailed** (4071 + the 7 added here). pyright **0 errors**. ruff clean. Commit.

...
- [ ] 8.1 Run initial QSNN-PPO sessions on pursuit predators config
- [ ] 8.2 Analyse results and compare against QSNN Reinforce baseline
- [ ] 8.3 Tune hyperparameters based on training metrics
- [ ] 8.4 Update logbook with QSNN-PPO results

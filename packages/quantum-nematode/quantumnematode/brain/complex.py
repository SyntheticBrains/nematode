...
class ComplexBrain(Brain):
    ...
    def copy(self) -> "ComplexBrain":
        ...
        -------
        ComplexBrain
            A new instance of the ComplexBrain class with the same parameters.
        """
        error_msg = "Copying ComplexBrain is not implemented. Please implement the copy method."

...
## tmp/evaluations/coevolution/pr6_zcand_20260512T094431Z/z2/run/20260512_115849_99b02b9b

- Prey per-gen series: n=20, min=0.010, max=0.932, std=0.285
- Predator per-gen series: n=20, min=2.281, max=6.406, std=0.893
- Prey K-block-elite series: [0.96, 1.0]
- Predator K-block-elite series: [6.166666666666667, 7.583333333333333]

### R4 (per-generation series)

- Prey cycling_detected=False period=3 p=0.9361
- Predator cycling_detected=False period=13 p=0.1238
- Prey escalation_detected=True slope=+0.0338 sign=1 p=0.0000
- Predator escalation_detected=True slope=+0.1070 sign=1 p=0.0015

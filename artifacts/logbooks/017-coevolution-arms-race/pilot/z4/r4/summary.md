...
- Prey K-block-elite series: [0.0, 0.0]
- Predator K-block-elite series: [6.166666666666667, 6.666666666666667]

### R4 (per-generation series)

- Prey cycling_detected=False period=None p=NaN
- Predator cycling_detected=False period=13 p=0.9681
- Prey escalation_detected=False slope=+0.0000 sign=0 p=1.0000
- Predator escalation_detected=True slope=-0.1694 sign=-1 p=0.0000
